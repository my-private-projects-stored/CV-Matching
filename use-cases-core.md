# Use Case Specification (Core NCKH)
## Smart CV Matching & Recruitment System

## 1. Mục tiêu tài liệu
Tài liệu này đặc tả nhóm Use Case phục vụ trọng tâm nghiên cứu khoa học về AI matching trong tuyển dụng, bao gồm:
- Nhóm Use Case AI lõi (UC-CORE-01 đến UC-CORE-05).
- Nhóm Use Case nền tảng vận hành nghiệp vụ (UC-BASIC-01 đến UC-BASIC-13).
