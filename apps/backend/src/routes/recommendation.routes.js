...
// GET /api/recommendations/jobs?resume_id=<id>&limit=10&score_threshold=0&semantic_weight=0.7
router.get(
  "/jobs",
  requireAuth,
...
// GET /api/recommendations/resumes?job_id=<id>&limit=10&score_threshold=0&semantic_weight=0.7
router.get(
  "/resumes",
  requireAuth,
