...
- Nhóm Use Case AI lõi (UC-01 đến UC-05) phục vụ năng lực matching thông minh.
...
| UC-03 | SBERT Embedding, Cosine Similarity, TF-IDF/BM25, Hybrid Scoring, Qdrant, MongoDB | Hybrid Matching Score + explainable metadata |
